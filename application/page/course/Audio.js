...
class Audio extends Component {
    ...
    static navigationOptions = ({navigation}) => {
		...
		return {
            ...
            headerRight: () => {
                ...
                return (
                    <TouchableOpacity style={[styles.mr_15]} onPress={() => DeviceEventEmitter.emit('share', {type: 'audio', id: course.courseId, title: course.courseName, img: course.courseImg})}>
    ...
    render() {
        const {navigation} = this.props;
        const {loaded, cy, index, cindex, ccindex, currentPage,  canReward, canBuy, mediaId, playUrl, duration, user_integral, preview, preview_index, preview_imgs, collect, collectNum, clist, score, courseScore, teacherScore} = this.state;
